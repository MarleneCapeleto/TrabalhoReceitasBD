<%-- 
    Document   : navbar
    Created on : 28 de nov. de 2022, 22:31:41
...
<nav class="navbar navbar-expand-lg navbar-light bg-light font-titulo fixed-top ">
    <a class="navbar-brand cor-titulo" href="#">Fruta & Fruto</a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Alterna navegação">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-collapse d-flex justify-content-end fixd-top" id="navbarNav">
    <ul class="navbar-nav">
